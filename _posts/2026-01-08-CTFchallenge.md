...
## Regversing Challenge from Hack The Box 

I've been really enjoying the reverse engineering challenges from HTB and I recently completed one that I found very interesting. I will not post the name of the challenge or the flag to keep within HTB rules, but I wanted to do a write up as it involved a Linux root kit which is something I have not previously analysed.
